...
func setupUI() {
	...
	mainwin := ui.NewWindow("testWin", 800, 600, true)
	...
	clickCount := 0
	testButoon := ui.NewButton("Greeting!")
	testButoon.OnClicked(func(*ui.Button) {
		clickCount++
		greeting.SetText("Hello World: " + strconv.Itoa(clickCount))
	})
	vbox.Append(testButoon, false)
